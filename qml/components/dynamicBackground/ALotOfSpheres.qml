...
Shader
{
  iGlobalTimeIncrement: 0.1
  property int rayCastSteps: 40;
  property real exposure: 0.9;
  property real epsilon: 0.0001;
  property real maxDistance: 200.0;
  property real gridSize: 8.0;
  property real gridSizeSmall: 6.0;
  property real maxHeight: 10.0;
