...
Item {
  ...
  Component {
    ...
    Item{
      ...
      SpecialText {
        ...
        shadowEnabled: false
        onAccept:{
          config.generalConfig[configName] = text;
        }
      }
    }
  }
  ...
  Component {
    ...
    Switch {
      ...
      onCheckedChanged: {
        config.generalConfig[configName] = checked;
      }
    }
  }
    ...
    ListItem {
      ...
      Component.onCompleted:
      {
        ...
        case "label":
          ...
          if (configName)
            loader_item.item.children[1].text = config.generalConfig[configName];
          break
        case "text":
          loader_item.sourceComponent = component_text;
          loader_item.item.children[0].text = title;
        ...
        case "bool":
          ...
          if (configName){
            ...
            loader_item.item.checked = config.generalConfig[configName];
          }
          break
        }
      }
