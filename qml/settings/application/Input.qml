...
Item {
  ...
  Component {
    ...
    Item{
      ...
      SpecialText {
        ...
        shadowEnabled: false
        onAccept:{
          config.inputConfig[configName] = text;
        }
      }
    }
  }
  ...
  Component {
    ...
    Switch {
      ...
      onCheckedChanged: {
        config.inputConfig[configName] = checked;
      }
    }
  }
    ...
    ListItem {
      ...
      Component.onCompleted:
      {
        ...
        case "label":
          ...
          if (configName)
            loader_item.item.children[1].text = config.inputConfig[configName];
          break
        case "text":
          loader_item.sourceComponent = component_text;
          loader_item.item.children[0].text = title;
        ...
        case "bool":
          ...
          if (configName){
            ...
            loader_item.item.checked = config.inputConfig[configName];
          }
          break
        }
      }
