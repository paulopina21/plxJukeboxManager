...
Item {
  ...
  ListModel {
    id: settingsModel
    ListElement { title: "Label";   configName: ""; type:"label"  }
    ListElement { title: "Text";    configName: ""; type:"text"   }
    ListElement { title: "Integer"; configName: ""; type:"int"    }
    ListElement { title: "Boolean"; configName: ""; type:"bool"   }
  }
  ...
  Component {
    ...
    Item{
      ...
      SpecialText {
        ...
        shadowEnabled: false
        onAccept:{
          config.hardwareConfig[configName] = text;
        }
      }
    }
  }
  ...
  Component {
    ...
    Switch {
      ...
      onCheckedChanged: {
        config.hardwareConfig[configName] = checked;
      }
    }
  }
    ...
    ListItem {
      ...
      Component.onCompleted:
      {
        ...
        case "label":
          ...
          if (configName)
            loader_item.item.children[1].text = config.hardwareConfig[configName];
          break
        case "text":
          loader_item.sourceComponent = component_text;
          loader_item.item.children[0].text = title;
        ...
        case "bool":
          ...
          if (configName){
            ...
            loader_item.item.checked = config.hardwareConfig[configName];
          }
          break
        }
      }
